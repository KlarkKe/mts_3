...
gdjs.evtsExt__GamejoltAPI__FetchData.asyncCallback13261948 = function (runtimeScene, eventsFunctionContext, asyncObjectsList) {
...
};gdjs.evtsExt__GamejoltAPI__FetchData.asyncCallback13262468 = function (runtimeScene, eventsFunctionContext, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(eventsFunctionContext.localVariables);
{gdjs.evtTools.common.resolveAsyncEventsFunction((typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined));
}eventsFunctionContext.localVariables.length = 0;
}
