...
};gdjs.evtsExt__GamejoltAPI__AuthenticateUser.asyncCallback16369076 = function (runtimeScene, eventsFunctionContext, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtsExt__GamejoltAPI__CallGamejolt.func(runtimeScene, "users/auth", "", (typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined)), (runtimeScene) => (gdjs.evtsExt__GamejoltAPI__AuthenticateUser.asyncCallback16369076(runtimeScene, eventsFunctionContext, asyncObjectsList)));
}
}
